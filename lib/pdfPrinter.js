...
module.exports = async (req, res) => {
    try {
        ...
        // Load the logo image
        const logoPath = path.join(__dirname, '../images/express-delivery-icon.jpg');
        ...
        data.forEach((paket, index) => {
            ...
            // Add the logo in place of old logo + company details
            ...
            doc.image(logoPath, xPos + 10, yPos + 10, {
                fit: [labelWidth - 20, textStartY - (yPos + 10) - 5],
                align: 'center',
                valign: 'center'
            });

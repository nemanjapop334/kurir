...
// Kao pdfPrinter (osnovna + poštarina + ukupno), ali 4 adresnice po A4
module.exports = async (req, res) => {
    try {
        if (!ensurePdfAccess(req, res, 'pdf5')) {
            return;
        }
        ...
        data.forEach((paket, index) => {
            ...
            placeField(`Osnovna cena: ${paket.cena} RSD Poštarina: ${paket.ptt} RSD`, 13, 'Arial');
            placeField(`Ukupno: ${paket.cena + paket.ptt} RSD`, 14, 'ArialBold');
